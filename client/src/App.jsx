  ...
  return (
    <div className="App">
      <header style={{ marginBottom: '3rem' }}>
        <h1>CreditFlow <span style={{ color: '#fff', fontSize: '1.5rem', verticalAlign: 'middle', opacity: 0.6 }}>Decision System</span></h1>
        <p style={{ color: '#a8dadc' }}>Enterprise-grade MSME Lending Decisions in Seconds</p>
      </header>
